...
public class ControlPanel extends JPanel {
    ...
    public ControlPanel() {
        ...
        custom1 = new JButton("Hydreigon");
        custom1.addActionListener(new ButtonListener("Hydreigon"));
        add(custom1);

        custom2 = new JButton("Zekrom");
        custom2.addActionListener(new ButtonListener("Zekrom"));
        add(custom2);
